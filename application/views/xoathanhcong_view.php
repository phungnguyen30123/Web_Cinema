...
<body>
 ...
 <div class="main">   
    ...
    <label for="chk" aria-hidden="true">XOÁ THÀNH CÔNG</label>
    ...
    <div class="login">
    <form>
    <label  aria-hidden="true" ><a href="<?php echo base_url() ?>index.php/Nhanvien_controller" style="text-decoration: none; ">TRANG CHỦ</a></label>
     <button> <button>
    </form>
    </div>
</div>
