...
<body>
 ...
 <div class="main">   
    ...
    <label for="chk" aria-hidden="true">ADMIN ĐĂNG NHẬP THÀNH CÔNG</label>
    ...
    <div class="login">
    <form>
    <label  aria-hidden="true" ><a href="<?php echo base_url() ?>index.php/showadmin_controller" style="text-decoration: none; ">TRANG CHỦ ADMIN</a></label>
     <button> <button>
    </form>
    </div>
</div>
