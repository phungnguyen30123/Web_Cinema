...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="<?php echo base_url('') ?>index.php/showadmin_controller"><i class='app-menu__icon bx bx-task'></i><span
            class="app-menu__label">Quản lý khách hàng</span></a></li>
      
      <li><a class="app-menu__item" href="<?php echo base_url(); ?>index.php/showadmin_controller/index_qlnv"><i class='app-menu__icon bx bx-id-card'></i>
            ...
            <div class="tile-body">
              <div class="row element-button">
                <div class="col-sm-2">
                 ...
                 <a class="btn btn-add btn-sm" href="showadmin_controller/index_insertnv" title="Thêm"><i class="fas fa-plus"></i>
                    Thêm nhân viên</a>
                </div>
                </div>
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <td>
                  <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><a href="showadmin_controller/deleteuser/<?= $value['id'] ?>" class="btn btn-danger xoa"><i class="fas fa-trash-alt"></i></a> </button>
                </td>
