...
<body>
 ...
 <div class="main">   
    ...
    <label for="chk" aria-hidden="true">NHÂN VIÊN ĐĂNG NHẬP THÀNH CÔNG</label>
    ...
    <div class="login"  >
    <form >
    <label  aria-hidden="true"  style="height:50px; width: 450px;"><a href="<?php echo base_url() ?>index.php/Nhanvien_controller" style="text-decoration: none; " > TRANG CHỦ NHÂN VIÊN</a>
    </label>
     <button > <button>
    </form>
    </div>
