    ...
    <main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item active"><a href="#"><b>Quản lý nhân viên</b></a></li>
        </ul>
        <div id="clock"></div>
      </div>
      <div class="row">
            ...
            <div class="tile-body">
              <div class="row element-button">
                <div class="col-sm-2">
                  ...
                  <a class="btn btn-add btn-sm" href="index_insertnv" title="Thêm"><i class="fas fa-plus"></i>
                    Thêm nhân viên</a>
                </div>
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <td>
                  <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"><a href="xoanv/<?= $value['id'] ?>" class="btn btn-danger xoa"><i class="fas fa-trash-alt"></i></a> </button>
                </td>
